...
export default function ProductCard({product, addToCart}) {
  ...
  return (
      <div className="card w-100 korttibg">
        <img src={product.kuvatiedosto} className="card-img-top img-fluid my-2 bg-white m-1 p-1" alt={product.tuotenimi} style={{ width: "auto", height: "200px", objectFit: "scale-down" }}></img>
